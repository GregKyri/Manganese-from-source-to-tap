...
Training_input_check=MLtrain(:,[(6:(6+Scolno+Scolno_step-1)) ((6+Scolno+Scolno_step+2):end)]);
Categorical_input=categorical(MLtrain.WTW); 
...
Training_input=Training_input_check(:,1:Scolno+Scolno_step);
Training_output=Training_input_check(:,(Scolno+Scolno_step+1):end);
